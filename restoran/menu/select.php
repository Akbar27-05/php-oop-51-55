    ...
    <tbody>
      <?php if(!empty($row)){?>
        ...
        <tr>
            ...
            <td><img style="width: 90px;" src="../upload/<?php echo $r['gambar']?>" alt=""></td>
            <td><a href="?f=menu&m=delete&id=<?php echo $r['idmenu']?>">Hapus</a></td>
            <td><a href="?f=menu&m=update&id=<?php echo $r['idmenu']?>">Ubah</a></td>
        </tr>
        <?php endforeach ?>
      <?php }else{ echo "<h6>Data belum di tambahkan</h6>";}?>
    </tbody>
</table>
